...
Page({ data: { catalog: null as any, mode: 'walks', walks: [] as any[], pois: [] as any[], stationOptions: [] as any[], categories: ['全部', '吃什么', '喝什么', '看什么', '玩什么', '休息'], category: '全部', nodeId: 'all', error: '' }, async onShow() { this.setData({ error: '' }); try {
