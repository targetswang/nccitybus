...
先按 [研发指南](DEVELOPER_GUIDE.md) 启动项目，再核对 [当前状态](STATUS.md) 和 [三端一致性](CLIENT_PARITY.md)。手机号、验证码及环境配置只在研发指南维护。

| 工作 | 权威说明 |
|---|---|
| 理解代码职责与数据流 | [仓库结构](REPOSITORY_STRUCTURE.md)、[架构](ARCHITECTURE.md) |
| 联调接口 | [API](API.md)、[OpenAPI](openapi.json)、[数据库](DATABASE.md) |
...
历史审查记录描述对应提交，不作为当前缺陷清单。旧阶段状态及重复交接副本已合并，当前结论统一维护在 STATUS.md。
